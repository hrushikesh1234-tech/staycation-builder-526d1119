...
const PropertyCard = ({
  ...
  return (
    <Link to={`/property/${id}`} className="block h-full">
      <div className="group bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-700 hover:-translate-y-2 cursor-pointer h-full">
        {/* Image Container */}
